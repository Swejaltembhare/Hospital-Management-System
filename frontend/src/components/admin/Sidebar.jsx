      ...
      >
        <div className="flex flex-col h-full">
          ...
          <div className="px-3 py-3">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-9 pr-3 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-teal-500/20 focus:border-teal-500 transition-all"
              />
            </div>
          </div>
          ...
          <div className="px-3 pb-3 border-b border-gray-100/80">
            <div className="flex items-center gap-3 p-2 rounded-xl bg-gradient-to-r from-teal-50 to-teal-100/30">
              <div className="w-10 h-10 rounded-full bg-gradient-to-r from-teal-500 to-cyan-600 flex items-center justify-center text-white font-semibold text-sm shadow-md shadow-teal-500/20 flex-shrink-0">
